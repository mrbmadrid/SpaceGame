...
import edu.hpu.spain.Objects2D.Body.BodyType;


/**
 * This class creates background images and polygons for
 * a SpaceGame Level.
 * @author Cloud
 *
 */
public class Background {
	//This will hold all the polygons for collision in the level.
	List<Terrain> bounds;
	//The image of the level.
	final BufferedImage background;
	
	/**
	 * Constructor that creates a background of requested width
	 * and height.
